...
class _QWen3_VL_Interface(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # VLA inference/training consumes hidden states from a single full
        # sequence pass; it never performs autoregressive decoding here.
        # Avoid constructing and retaining KV caches.  `generate()` below
        # calls the underlying model directly and keeps its normal behavior.
