...
def update_processor_pixels(processor, data_args):
    ...
    if hasattr(processor, "video_processor") and processor.video_processor is not None:
        ...
        if hasattr(vp, "min_pixels") and hasattr(vp, "max_pixels") and hasattr(data_args, "video_min_pixels") and hasattr(data_args, "video_max_pixels"):
        ...
        if hasattr(vp, "min_frames") and hasattr(vp, "max_frames") and hasattr(data_args, "video_min_frames") and hasattr(data_args, "video_max_frames"):
        ...
        if hasattr(vp, "fps") and hasattr(data_args, "video_fps"):
            vp.fps = data_args.video_fps
            rank0_print(f"✅ Updated video_processor fps to {data_args.video_fps}")

        if hasattr(vp, "size") and isinstance(vp.size, dict) and hasattr(data_args, "video_min_pixels") and hasattr(data_args, "video_max_pixels"):
...
def _build_messages(item: Dict[str, Any], base_path: Path) -> List[Dict[str, Any]]:
    # Extract and normalize images and videos (support both singular and plural keys)
